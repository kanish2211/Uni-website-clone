      ...
      {width >= 768 ? (
        <div className="grid grid-cols-2">
          <div className="lg:ml-28 ml-10">
            <p className="lg:text-xl text-xl font-semibold lg:leading-normal uniGreen">
              Coming Soon!
            </p>
          ...
          <div className="mt-24">
            <img
              className=" ml-12 lg:w-7/12 w-60 rotate-180 "
              src="https://www.uni.cards/images/redesign/semi-circle.svg"
            />
            <img
              className="lg:-mt-72 lg:w-96 -mt-60 w-80 absolute "
              src="https://www.uni.cards/images/redesign/time.webp"
            />
          </div>
        </div>
      ) : (
        <div>
          ...
          <div className="mt-36 w-72 mx-auto mb-10">
            <img
              className=" ml-16 w-52 rotate-180"
              src="https://www.uni.cards/images/redesign/semi-circle.svg"
            />
            <img
